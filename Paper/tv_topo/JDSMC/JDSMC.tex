...
\begin{document}
	...
	\begin{abstract}
		...
		It is proved that each UGV can disseminate its measurements over the whole network within the finite time and is able to achieve the consistency of environmental state estimation. The effectiveness of this method is validated by comparing with consensus-based distributed filters and centralized filter in a multi-target tracking problem.
