...
By exchanging full communication buffers among neighboring robots, LIFO significantly reduces the transmission burden between each pair of robots to be linear of robot number.
%, with each robot non-intermittently receiving observations of all others.
...
Future work includes how to handle other types of sensors and imperfect communication between robots.
...
Imperfect communication, including package loss, out-of-order measurement and transmission delay, requires extension to LIFO-DBF and may affect its consistency and consensus properties.
